...
const customerService = {
    getCustomersMedium: () => {
        return new Promise((resolve) => {
            const data = [
                { id: 1, name: 'John Doe', country: { code: 'us', name: 'United States' }, representative: { name: 'Amy Elsner', image: 'amyelsner.png' }, status: 'qualified', verified: true },
                { id: 2, name: 'Jane Smith', country: { code: 'ca', name: 'Canada' }, representative: { name: 'Anna Fali', image: 'annafali.png' }, status: 'new', verified: false },
            ];
            resolve(data);
        });
    }
